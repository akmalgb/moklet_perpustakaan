...
<body>
    ...
    <a class="navbar-brand" href="../index.php"><i class="fas fa-book-open"></i> PERPUS MOKLET(keanggotaan)</a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                <a href="user_anggota.php" class="nav-item nav-link active">Home</a>
                <a href="tampil_buku_readonly.php" class="nav-item nav-link">Book</a>
    ...
    <div class="container" style="margin-top:20px">
        ...
        <div class="text-center">
            <h3 class="welcome"> Lapor ke petugas untuk menambahkan daftar buku! </h3>
            <h4> <a href="../logout.php"> Klik untuk logout </a> </h4>
        </div>
