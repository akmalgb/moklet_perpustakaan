...
<body>
  <div class="text-center">
    <form action="log_petugas.php" method="post">
      <h2 style="color:#C0392B"><b>PETUGAS</b></h2>
      ...
      <button type="submit" class="btn btn-primary bg-light"><a href="reg_petugas.php">Daftar?</a></button>
    </form>
  </div>
</body> 
