...
<nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <a href="../anggota/user_petugas.php" class="navbar-brand">Beranda</a>
        ...
        <div id="myModal" class="modal fade" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="proses_edit_buku.php?id_buku=<?php echo $id_buku; ?>" method="post">
                        ...
                        <div class="modal-body">       
                            <div class="form-group">
                                ...
                                <input type="text" name="id_kategori"class="form-control" value="<?php echo $data['id_kategori']; ?>" readonly required>
                            </div>                 
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="ringkasan" class="form-control" value="<?php echo $data['ringkasan']; ?>" required>
                            </div>
                            <div class="form-group">
                                <label class="control-label">Cover</label>
                                <input type="text" name="cover" class="form-control" value="<?php echo $data['cover']; ?>" required>
                            </div>
                            <div class="form-group">
