        ...
        <div class="modal-dialog">
            <div class="modal-content">
				...
				<div class="container-fluid">
                    <h5><center>Kode Buku: <strong><?php echo $deleteData['id_kategori']; ?></strong></center></h5> 
                ...
                <form method="POST" action="proses_edit_buku.php?id_buku=<?php echo $editData['id_buku']; ?>">
                    ...
                    <div class="modal-body">       
                        <div class="form-group">
                            ...
                            <input type="text" name="id_kategori"class="form-control" value="<?php echo $editData['id_kategori']; ?>" readonly>
                        </div>                 
                        <div class="form-group">
