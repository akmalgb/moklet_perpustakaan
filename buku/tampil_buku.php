...
<body>
    <nav class="navbar navbar-expand-md navbar-dark bg-dark">
        <a href="../index.php" class="navbar-brand"><i class="fas fa-book-open"></i> PERPUS MOKLET</a>
        <button type="button" class="navbar-toggler" data-toggle="collapse" data-target="#navbarCollapse">
            <span class="navbar-toggler-icon"></span>
        </button>
        <div class="collapse navbar-collapse" id="navbarCollapse">
            <div class="navbar-nav">
                <a href="../petugas/user_petugas.php" class="nav-item nav-link active">Home</a>
                <a href="tampil_buku.php" class="nav-item nav-link">Book</a>
